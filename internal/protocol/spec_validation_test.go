...
func TestProtocolSchemaValidation(t *testing.T) {
	...
	assertRequiredField(t, reqs, "set_leaf", "leaf_id")
	assertCommandKeyExists(t, reqs, "get_tree")
	...
	assertRequiredField(t, respReqs, "leaf", "session_id")
	assertRequiredField(t, respReqs, "leaf", "leaf_id")
	assertRequiredField(t, respReqs, "tree", "session_id")
	assertRequiredField(t, respReqs, "tree", "nodes")
